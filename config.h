...
static const char *fonts[]          = { "Ubuntu Mono Nerd Font:size=14", "JetBrains Mono:pixelsize=10:antialias:true" };
...
static const char *dmenucmd[] ={ "dmenu_run", "-i", "-hp", "chromium", "-p", ">", NULL };
